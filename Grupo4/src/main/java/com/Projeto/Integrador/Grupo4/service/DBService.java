...
public class DBService {
	...
	public void instanceDB() {
		...
		CategoryModel c1 = new CategoryModel("Aventura/Sátira/Romance psicológico","Moderna","EPub",9);
		CategoryModel c2 = new CategoryModel("Aventura/Fantasia"," Vide Editorial", "Livro",12);
		CategoryModel c3 = new CategoryModel("Aventura/Ação/Mistério/Suspense","Arqueiro","eBook",14);
		CategoryModel c4 = new CategoryModel("Aventura/Romance/Ficção Marítima","Harper Perennial","ePub",10);
		CategoryModel c5= new CategoryModel("Aventura/Romance/Suspense/Ficção Científica","Rocco Digital","eBook",12);
		BookModel b1 = new BookModel("Dom Quixote"," Apaixonado por histórias de cavalaria, Alonso Quijano "
				...
				+ " | WALCYR CARRASCO",2009,50,"Português",9788516083373l,2000175600256l,"Brasil",100,c1);
		BookModel b2 = new BookModel("Alice no País das Maravilhas","Uma menina, um coelho e uma história capazes de "
				...
				69.90,"LEWIS CARROLL",2021,48,"Português",65898750301l,9786589875031l,"Brasil",150,c2);
		BookModel b3 = new BookModel("O Código da Vinci","Um assassinato dentro do Museu do Louvre, em Paris, traz à tona uma "
				...
				+ "autores mais brilhantes da atualidade.",23.99,"Dan Brown",2012,37,"Português",9788580410853l,2008900670284l,"Brasil",432,c3);
		BookModel b4 = new BookModel("Anjos e Demônios","Antes de decifrar O Código Da Vinci, Robert Langdon, o famoso professor de simbologia "
				...
				"Português",9788580410860l,2020139322055l,"Brasil",616,c3);
